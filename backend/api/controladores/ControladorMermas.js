...
const Merma = db.Merma;


// Retorna todas las Merma en la tabla.
exports.getMermas = async(request, respuesta) => {
  // GET request.
  try {
    const reporte = await Merma.findAll();
...
exports.addMerma = async(request, respuesta) => {
  // POST request.
  ...
  try {
    ...
    Merma.create(reporte).then((resultado) => {
...
exports.updateMerma = async(request, respuesta) => {
  // PUT request.
  const datos = request.body;
  ...
  const entrada = await Merma.findOne({
    where: {
      id: id
    }
  });
...
exports.deleteMerma = async(request, respuesta) => {
  // DELETE request.
  ...
  const reporte = await Merma.findOne({
    where: {
      id,
    },
  });
